module.exports = function (grunt) {
  var config = {
    ...
    uglify: {
      ...
      target: {
        ...
        'public/js/app.min.js': ['public/vendor/jquery/dist/jquery.min.js',
                                 'public/vendor/bootstrap/dist/js/bootstrap.min.js',
                                 'public/js/materialize.min.js', 'public/js/main.js']
      }
    },
    less: {
      src: {
  ...
  grunt.registerTask('default', ['uglify', 'less', 'cssmin', 'concat:css', 'concurrent']);
};
