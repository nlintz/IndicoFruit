...
var FruitAPI = {
    ...
    getLastUpdate: function getLastUpdate(cb) {
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('img', { src: img_url }),
                React.createElement('img', { className: show_x, src: '/img/X.png' })
            ),
            React.createElement(
                'div',
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'row no-margin-left' },
                    React.createElement(
                        'h5',
                        null,
                        'Sign Up For Alerts When We Run Out Of Fruit'
                    ),
...
var LastUpdate = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'row last-update-container' },
            React.createElement(
                'div',
...
var Fruits = React.createClass({
    ...
    loadFruitsFromServer: function loadFruitsFromServer() {
    ...
    loadLastUpdateFromServer: function loadLastUpdateFromServer() {
    ...
    getInitialState: function getInitialState() {
        return { fruits: [{ name: "apple", p_exists: 0.0 }, { name: "orange", p_exists: 0.0 }, { name: "banana", p_exists: 0.0 }],
            last_update: ""
        };
    },
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'container' },
                React.createElement(FruitProbas, { fruits: this.state.fruits }),
                React.createElement(LastUpdate, { last_update: this.state.last_update }),
...
React.createElement(Fruits, null), document.getElementById('content'));
